...
def test_polynomial_feature_map_num_terms():
    ...
    my_polynomial_feature_map = feature_maps.PolynomialFeatureMap( [I1,I2], [0])  
    my_polynomial_feature_map.compute_num_terms()
    sys.stdout=my_polynomial_feature_map.num_terms
    assert my_polynomial_feature_map.num_terms == 1    

    my_polynomial_feature_map = feature_maps.PolynomialFeatureMap([I1,I2], [2,2])  
    my_polynomial_feature_map.compute_num_terms()
    sys.stdout=my_polynomial_feature_map.num_terms
    assert my_polynomial_feature_map.num_terms == 3   
        
    my_polynomial_feature_map = feature_maps.PolynomialFeatureMap([I1,I2], [2,1,2])  
    my_polynomial_feature_map.compute_num_terms()
    sys.stdout=my_polynomial_feature_map.num_terms
    assert my_polynomial_feature_map.num_terms == 5    
    
    my_polynomial_feature_map = feature_maps.PolynomialFeatureMap([I1,I2,I3], [2])  
    my_polynomial_feature_map.compute_num_terms()
    sys.stdout=my_polynomial_feature_map.num_terms
    assert my_polynomial_feature_map.num_terms == 6
    
    my_polynomial_feature_map = feature_maps.PolynomialFeatureMap([I1,I2,I3], [2,1,2,1,1])  
    my_polynomial_feature_map.compute_num_terms()
    sys.stdout=my_polynomial_feature_map.num_terms
...
def test_polynomial_feature_map():
    ...
    my_polynomial_feature_map = feature_maps.PolynomialFeatureMap([I1,I2], [2])  
    my_polynomial_feature_map.compute_num_terms()
    first_element = my_polynomial_feature_map.get_mapped_feature_vec_element(1)
    result = np.multiply(I1,I2)
    assert (first_element == result).all() 
        
    my_polynomial_feature_map = feature_maps.PolynomialFeatureMap([I1,I2], [2,2,1,2])  
    my_polynomial_feature_map.compute_num_terms()
    first_element = my_polynomial_feature_map.get_mapped_feature_vec_element(1)
    result = I2
    assert (first_element == result).all()   
