...
def compute_atlas_from_labelfiles(input_vol, testing_ct_filename, training_ct_filenames,\
    ...
    alpha_p_distance_given_class = dict()
    prior_probabilities = dict()
    all_classes = ["leftmajor","leftminor","rightmajor","rightminor","nonpec"]
    ...
    """
    find the most similar cases by computing similarity.
    ...
    closest_cases  = getClosestCases(training_labelmap_filenames, \
            training_similarity_files, "ncc", num_closest_cases, threshold_value_for_similarity)  
