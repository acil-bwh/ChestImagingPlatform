...
#include <New/vtkComputeMonogenicSignal.h>
...
// ---------------------------------------------------------------------------
// Testing vtkComputeMonogenicSignal
...
int main(int, char *[])
{
  ...
  vtkSmartPointer<vtkGeneralizedQuadratureKernelSource> kernel =
	  vtkSmartPointer<vtkGeneralizedQuadratureKernelSource>::New();
  kernel->Update();
 
  vtkSmartPointer<vtkComputeMonogenicSignal> filter =
    vtkSmartPointer<vtkComputeMonogenicSignal>::New();

  filter->SetInputInFourierDomain(0);
  filter->SetQuadratureFilter(kernel);
