...
#include <New/vtkImageResliceWithPlane.h>
...
// ---------------------------------------------------------------------------
// Testing vtkImageResliceWithPlane
...
int main(int, char *[])
{
  ...
  vtkSmartPointer<vtkImageResliceWithPlane> filter =
    vtkSmartPointer<vtkImageResliceWithPlane>::New();
