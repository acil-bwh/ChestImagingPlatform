...
bool cipVesselParticleConnectedComponentFilter::EvaluateParticleConnectedness( unsigned int particleIndex1, unsigned int particleIndex2 )
{
  ...
  double particle1Hevec2[3];
    particle1Hevec2[0] = this->InternalInputPolyData->GetFieldData()->GetArray( "hevec0" )->GetTuple( particleIndex1 )[0];
    particle1Hevec2[1] = this->InternalInputPolyData->GetFieldData()->GetArray( "hevec0" )->GetTuple( particleIndex1 )[1];
    particle1Hevec2[2] = this->InternalInputPolyData->GetFieldData()->GetArray( "hevec0" )->GetTuple( particleIndex1 )[2];

  double particle2Hevec2[3];
    particle2Hevec2[0] = this->InternalInputPolyData->GetFieldData()->GetArray( "hevec0" )->GetTuple( particleIndex2 )[0];
    particle2Hevec2[1] = this->InternalInputPolyData->GetFieldData()->GetArray( "hevec0" )->GetTuple( particleIndex2 )[1];
    particle2Hevec2[2] = this->InternalInputPolyData->GetFieldData()->GetArray( "hevec0" )->GetTuple( particleIndex2 )[2];
