...
bool cipVesselParticleConnectedComponentFilter::EvaluateParticleConnectedness( unsigned int particleIndex1, unsigned int particleIndex2 )
{
  ...
  // same scale
  double scale1 = this->InputPolyData->GetPointData()->GetArray( this->RadiusName )->GetTuple( particleIndex1 )[0];
  double scale2 = this->InputPolyData->GetPointData()->GetArray( this->RadiusName )->GetTuple( particleIndex2 )[0];
...
void cipVesselParticleConnectedComponentFilter::SetRadiusName( const char* radiusName )
{
