...
function(midas_add_test)
  ...
  # list(FIND ARGN "MIDAS_TOKEN" tokenIndex)
  # if(NOT tokenIndex EQUAL "-1")
  #   list(GET ARGN tokenIndex+1 token)
  ...
  foreach(arg ${ARGN})
    if(NOT arg MATCHES "MIDAS[a-zA-Z_]*{[^}]*}")
        ...
        if(keyword STREQUAL "MIDAS_DIRECTORY")
          ...
          foreach(keyFile ${fileList})
            if(NOT IS_DIRECTORY "${MIDAS_KEY_DIR}/${keyFile}")
              _process_keyfile("${keyFile}" ${testName} 0 ${tokenId})
            endif(NOT IS_DIRECTORY "${MIDAS_KEY_DIR}/${keyFile}")
          endforeach(keyFile ${fileList})
        elseif(keyword STREQUAL "MIDAS_TGZ")
          _process_keyfile("${parameter}" ${testName} 1 ${tokenId})
        elseif(keyword STREQUAL "MIDAS_TOKEN")
          set(tokenId ${parameter})
        else()
          _process_keyfile("${parameter}" ${testName} 0 ${tokenId})
      ...
      if(NOT keyword STREQUAL "MIDAS_FETCH_ONLY" AND NOT keyword STREQUAL "MIDAS_TOKEN")
...
macro(_process_keyfile keyFile testName extractTgz tokenId)
