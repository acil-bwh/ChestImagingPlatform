...
typedef itk::ImageSeriesReader< ShortImageType >                                                          CTSeriesReaderType;
typedef itk::GDCMImageIO                                                                               ImageIOType;
typedef itk::GDCMSeriesFileNames                                                                       NamesGeneratorType;
typedef itk::ImageFileReader< ShortImageType >                                                            CTFileReaderType;
typedef itk::ImageRegionIteratorWithIndex< ShortImageType >                                         LabelMapIteratorType;
...
/*
  ...
  */
  ...
  //This was commented. Check if not needed for similarity. its cause composite doesnt work
/*
  ...
  std::cout<<"initializing metric"<<std::endl;
	...
	msqrMetricType::Pointer metric = msqrMetricType::New();
    ...
    else if (similarityMetric =="nc")
      {
          ...
          if ( strcmp( fixedLabelmapFileName.c_str(), "q") != 0 )
          {
              std::cout<<"fixing label map "<<fixedLabelmapFileName.c_str()<<std::endl;
              metric->SetFixedImageMask( spatialObjectMask );
          }
