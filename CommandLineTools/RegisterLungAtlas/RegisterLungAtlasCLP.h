...
//  /Users/jross/Downloads/Slicer4/Slicer4-SuperBuild-Release/SlicerExecutionModel-build/GenerateCLP/bin/GenerateCLP --InputXML /Users/jross/Downloads/ChestImagingPlatformPrivate/CommandLineTools/RegisterLungAtlas/RegisterLungAtlas.xml --OutputCxx /Users/jross/Downloads/ChestImagingPlatformPrivate/CommandLineTools/RegisterLungAtlas/RegisterLungAtlasCLP.h
//
#include <cstdio>
#include <cstdlib>
#include <iostream>
...
"      <description><![CDATA[Convex hull mesh file name\n"
"]]></description>\n"
"      <default>q</default>\n"
"    </string>  \n"
"    <string>\n"
...
"      <channel>input</channel>\n"
"      <description><![CDATA[Threshold value for bone. Any voxel having HU intensity greater than or equal to this value will be considered bone and will be added to the fixed point set. \n"
"]]></description>\n"
"<default>600</default>\n"
"   </integer>\n"
"<integer>\n"
...
#define GENERATE_TCLAP \
    ...
    std::string convexHullMeshFileName = "q"; \
    std::string outputTransformFileName = "q"; \
    int boneThreshold = 600; \
 ...
 \
    ...
    msg.str("");msg << "CT file name (default: " << ctFileName << ")"; \
    TCLAP::ValueArg<std::string > ctFileNameArg("c", "ct", msg.str(), 0, ctFileName, "std::string", commandLine); \
 \
    msg.str("");msg << "Convex hull mesh file name (default: " << convexHullMeshFileName << ")"; \
    TCLAP::ValueArg<std::string > convexHullMeshFileNameArg("m", "mesh", msg.str(), 0, convexHullMeshFileName, "std::string", commandLine); \
 \
    msg.str("");msg << "Output transform file name (default: " << outputTransformFileName << ")"; \
    TCLAP::ValueArg<std::string > outputTransformFileNameArg("o", "trans", msg.str(), 0, outputTransformFileName, "std::string", commandLine); \
 \
    msg.str("");msg << "Threshold value for bone. Any voxel having HU intensity greater than or equal to this value will be considered bone and will be added to the fixed point set. (default: " << boneThreshold << ")"; \
    TCLAP::ValueArg<int > boneThresholdArg("b", "bone", msg.str(), 0, boneThreshold, "int", commandLine); \
 \
    msg.str("");msg << "Number of iterations (default: " << numberOfIterations << ")"; \
    TCLAP::ValueArg<int > numberOfIterationsArg("i", "iterations", msg.str(), 0, numberOfIterations, "int", commandLine); \
 \
...
std::cout << "    convexHullMeshFileName: " << convexHullMeshFileName << std::endl; \
std::cout << "    outputTransformFileName: " << outputTransformFileName << std::endl; \
std::cout << "    boneThreshold: " << boneThreshold << std::endl; \
