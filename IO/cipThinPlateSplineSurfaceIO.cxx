...
cipThinPlateSplineSurfaceIO::cipThinPlateSplineSurfaceIO()
{
  this->FileName = "NA";

  this->TPS = new cipThinPlateSplineSurface();
}
...
void cipThinPlateSplineSurfaceIO::SetFileName( std::string fileName )
{
  this->FileName = fileName;
}


void cipThinPlateSplineSurfaceIO::SetInput( cipThinPlateSplineSurface* tps )
{
  this->TPS = tps;
}


void cipThinPlateSplineSurfaceIO::Write() const
{
  // //
...
void cipThinPlateSplineSurfaceIO::Read()
{
  // //
  // // Check to see if the file name has been set to something other
  // // than the default
...
cipThinPlateSplineSurface* cipThinPlateSplineSurfaceIO::GetOutput()
{
  return this->TPS;
}
