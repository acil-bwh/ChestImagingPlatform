...
cipLobeBoundaryShapeModelIO::cipLobeBoundaryShapeModelIO()
{
  this->FileName = "NA";

  this->ShapeModel = new cipLobeBoundaryShapeModel();
}
...
void cipLobeBoundaryShapeModelIO::SetFileName( std::string fileName )
{
  this->FileName = fileName;
}


void cipLobeBoundaryShapeModelIO::SetInput( cipLobeBoundaryShapeModel* shapeModel )
{
  this->ShapeModel = shapeModel;
}


void cipLobeBoundaryShapeModelIO::Write() const
{
  //
...
void cipLobeBoundaryShapeModelIO::Read()
{
  //
  // Check to see if the file name has been set to something other
  // than the default
...
cipLobeBoundaryShapeModel* cipLobeBoundaryShapeModelIO::GetOutput()
{
