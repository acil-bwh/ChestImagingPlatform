...
have incorrectly labeled chest regions and relables them properly.";
  ...
  unsigned short leftSubcutaneousLabel = conventions.GetValueFromChestRegionAndType( (unsigned char)(cip::LEFT), (unsigned char)(cip::SUBCUTANEOUSFAT) );
  unsigned short rightSubcutaneousLabel  = conventions.GetValueFromChestRegionAndType( (unsigned char)(cip::RIGHT), (unsigned char)(cip::SUBCUTANEOUSFAT) );

  // These are the wrong labels
  unsigned short middleThirdMajorLabel = conventions.GetValueFromChestRegionAndType( (unsigned char)(cip::MIDDLETHIRD), (unsigned char)(cip::PECTORALISMAJOR) );
  unsigned short middleThirdMinorLabel = conventions.GetValueFromChestRegionAndType( (unsigned char)(cip::MIDDLETHIRD), (unsigned char)(cip::PECTORALISMINOR) );
  unsigned short upperThirdMajorLabel  = conventions.GetValueFromChestRegionAndType( (unsigned char)(cip::UPPERTHIRD), (unsigned char)(cip::PECTORALISMAJOR) );
  unsigned short upperThirdMinorLabel  = conventions.GetValueFromChestRegionAndType( (unsigned char)(cip::UPPERTHIRD), (unsigned char)(cip::PECTORALISMINOR) );
  ...
  relabelMapper[middleThirdMajorLabel]=rightMajorLabel;
  relabelMapper[middleThirdMinorLabel]=rightMinorLabel;
  relabelMapper[upperThirdMajorLabel]=leftMajorLabel;
  relabelMapper[upperThirdMinorLabel]=leftMinorLabel;
  relabelMapper[leftSubcutaneousLabel]=leftSubcutaneousLabel;
  relabelMapper[rightSubcutaneousLabel]=rightSubcutaneousLabel;
