...
execute_process(
  COMMAND "/usr/bin/git" show-ref 87f5d83f15929900aea038abed43d46a14b69886
  WORKING_DIRECTORY "/home/mylap9/CIP_Feb2021/ChestImagingPlatform/build/ITKv4"
...
if("${show_ref_output}" MATCHES "refs/remotes/87f5d83f15929900aea038abed43d46a14b69886")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "87f5d83f15929900aea038abed43d46a14b69886")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "87f5d83f15929900aea038abed43d46a14b69886")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 87f5d83f15929900aea038abed43d46a14b69886
  WORKING_DIRECTORY "/home/mylap9/CIP_Feb2021/ChestImagingPlatform/build/ITKv4"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/mylap9/CIP_Feb2021/ChestImagingPlatform/build/ITKv4/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/mylap9/CIP_Feb2021/ChestImagingPlatform/build/ITKv4/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
