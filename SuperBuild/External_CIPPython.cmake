...
if (CIP_PYTHON_INSTALL)
  ...
  if (WIN32)
    set(CIP_PYTHON_BIN_FOLDER ${CIP_PYTHON_BIN_FOLDER}/Scripts)
  endif()
  ...
  if (CIP_PYTHON_INSTALL_DL_TOOLS)
    ...
    ExternalProject_Add_Step(${proj} installtensorflow
        COMMAND ${CIP_PYTHON_BIN_FOLDER}/conda install --yes -c conda-forge tensorflow==1.2.1
        DEPENDEES install
    )
    ExternalProject_Add_Step(${proj} installkeras
        COMMAND ${CIP_PYTHON_BIN_FOLDER}/pip install keras==2.0.8
  ...
  ExternalProject_Add_Step(${proj} installnipype
          COMMAND ${CIP_PYTHON_BIN_FOLDER}/conda install --yes -c conda-forge nipype==0.12.1
          DEPENDEES ${last_dep}
          )

  ExternalProject_Add_Step(${proj} installnetworkx
          COMMAND ${CIP_PYTHON_BIN_FOLDER}/conda install --yes -c conda-forge networkx==1.11
          DEPENDEES installnipype
  )

  ExternalProject_Add_Step(${proj} installscikit-image
          COMMAND ${CIP_PYTHON_BIN_FOLDER}/conda install --yes -c conda-forge scikit-image
  ...
  ExternalProject_Add_Step(${proj} installpynrrd
          COMMAND ${CIP_PYTHON_BIN_FOLDER}/pip install pynrrd
          DEPENDEES installscikit-image
          )

  ExternalProject_Add_Step(${proj} installpydicom
          COMMAND ${CIP_PYTHON_BIN_FOLDER}/pip install pydicom==1.1.0
          DEPENDEES installpynrrd
          )

  ExternalProject_Add_Step(${proj} installnibabel
          COMMAND ${CIP_PYTHON_BIN_FOLDER}/pip install nibabel
  ...
  if (CIP_PYTHON_USE_QT4)
    ...
    ExternalProject_Add_Step(${proj} installqt4
            COMMAND ${CIP_PYTHON_BIN_FOLDER}/conda install --yes qt=4.8.7
